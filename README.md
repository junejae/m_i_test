...
- `mig-vllm-1`: `google/gemma-2-2b-it` (text-focused config)
...
VLLM_EXTRA_ARGS_1=--swap-space 16 --cpu-offload-gb 10 --enforce-eager
...
- `gemma-2-2b-it` 사용 전 Hugging Face에서 모델 사용 약관 동의가 필요할 수 있습니다.
